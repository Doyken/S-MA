...
def dev_process(opt, critertion, cl_model, dev_loader,epoch,test_loader=None,last_F1=None, last_Accuracy=None, train_log=None, log_summary_writer:SummaryWriter=None,  gamma_1=1.0,):
    y_true = []
    y_pre = []
    total_labels = 0
    dev_loss = 0
    ...
    with torch.no_grad():
        ...
        for index, data in enumerate(dev_loader_tqdm):
            ...
            train_test = False
            t_log_prob, i_log_prob, all_log_prob, all_prob, kl_t_log_prob, kl_a_log_prob, kl_all_prob= cl_model(orgin_param,index,epoch,train_test)
            ...
            step_num += 1
            all_ke.append(all_prob.cpu().detach().numpy())
